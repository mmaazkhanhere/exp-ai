...
const TextSection = () => {
  return (
    <section className="flex flex-col w-full max-w-[1062px] items-center justify-center gap-10 mx-auto pt-16 text-center">
      <h2 className="text-6xl font-['BankGothic']">
        A NFT series like you&#39;ve never seen before
      </h2>

      <p className="max-w-[744px] mx-auto font-['Franie'] text-sm">
      ...
      <button className="px-10 py-5 rounded-lg bg-[linear-gradient(270deg,rgba(3,5,241,1)_0%,rgba(1,241,242,1)_100%)] font-['Franie'] hover:opacity-90 transition-opacity ">
        The lore
      </button>
    </section>
  );
